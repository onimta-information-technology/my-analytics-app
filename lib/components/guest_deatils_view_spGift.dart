...
//                   children: [
//                     // FIRST ROW: Profile Picture (left) + Member ID (right)
//                     Row(
...
//                     // SECOND ROW: Member Name (full width, left-aligned)
...
//                     // THIRD ROW: Member Principal (M P)
//                     Consumer(
//                       builder: (context, ref, child) {
//                         final selectedGuest = ref.watch(
//                           selectedGuestProvider,
...
//                     // FOURTH ROW: Last Visit Date (left) + Rating Image (right)
//                     Row(
