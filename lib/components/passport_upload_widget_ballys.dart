...
class PassportUploadWidgetBallys extends StatefulWidget {
  /// Called whenever the list of uploaded files changes.
  final ValueChanged<List<PassportFileBallys>>? onFilesChanged;
  ...
  @override
  State<PassportUploadWidgetBallys> createState() => _PassportUploadWidgetBallysState();
}

class _PassportUploadWidgetBallysState extends State<PassportUploadWidgetBallys> {
  final List<PassportFileBallys> _files = [];
...
class _FilePreviewBalyysCard extends StatelessWidget {
  final PassportFileBallys file;
  final VoidCallback onRemove;

  const _FilePreviewBalyysCard({required this.file, required this.onRemove});
