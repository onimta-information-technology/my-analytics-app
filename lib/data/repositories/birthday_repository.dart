  ...
  // }
   ...
   Future<void> saveGiftData({
    ...
    try {
      ...
      // Log error but don't throw - we still want to proceed with WhatsApp
      print('Error saving gift data: $e');
    }
  }
  //  Future<String> sendWhatsappMessage({
  //   required String mname,
