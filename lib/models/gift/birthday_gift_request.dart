class BirthdayIncressGiftRequest {
  final double idNo;
  final String mid;
  final String mname;
  final double mdrop;
  ...
  factory BirthdayIncressGiftRequest.fromJson(Map<String, dynamic> json) {
    ...
    return BirthdayIncressGiftRequest(
      ...
      prvGiftAmount: json['Priv_Gift_Amt'],
