...
class ReservationPassportImageBallys {
  final String guestBmNumber;
  final String fileName;
  final bool isPdf;
  final String base64Data;

  ReservationPassportImageBallys({
  ...
  factory ReservationPassportImageBallys.fromJson(Map<String, dynamic> json) {
    return ReservationPassportImageBallys(
