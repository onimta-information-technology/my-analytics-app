...
class _SpecialGiftRequestScreenState
  ...
  // Filter gifts based on user permissions
  Future<List<SpecialGiftRequest>> _filterGifts(List<SpecialGiftRequest> gifts) async {
    ...
    // For other users, only show gifts they requested
