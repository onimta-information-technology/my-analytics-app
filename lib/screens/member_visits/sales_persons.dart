...
class SalesPersonsScreen extends StatefulWidget {
  ...
  const SalesPersonsScreen(
      {super.key, required this.salesPersons, required this.title});
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        _filteredSalesPersons = widget.salesPersons.entries
            .where((entry) => entry.value[0].gName!
                .toLowerCase()
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final salesPersonName = entry.key;
                ...
                return Card(
                  ...
                  child: ListTile(
                    title: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(entry.value[0].gName ?? ''),
                        ),
                        const SizedBox(width: 10),
                        CircleAvatar(
                          radius: 18,
                          backgroundColor:
                              Constants.kPrimaryColor.withAlpha(90),
                          child: Text(
                            entry.value[0].mid == ''
                                ? '0'
