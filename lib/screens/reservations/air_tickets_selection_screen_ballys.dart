...
//   ///
//   /// [detail] is the follow-up input the option asks for — e.g. which leg the
//   /// facility applies to — and is shown only while the answer is Yes.
...
//   /// Arrival / Departure picker for the Silk and Gold Route facilities. Laid
//   /// out in a [Wrap] so it still fits when the option sits in a half-width
//   /// column on a narrow screen.
//   Widget _buildLegSelector({
//     required String value,
//     required ValueChanged<String> onChanged,
//   }) {
//     Widget leg(String label) {
//       return InkWell(
...
//     return Wrap(
//       spacing: 6,
//       children: [leg("Arrival"), leg("Departure")],
//     );
//   }
