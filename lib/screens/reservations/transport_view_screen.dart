            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (transport.isVehicleAssigned) ...[
                    const Divider(height: 20),
                    if (transport.vehicleAssignedLabel != null)
                      _infoRow(
                        Icons.directions_car,
                        'Vehicle',
                        transport.vehicleAssignedLabel!,
                        Colors.teal,
                        fontSettings,
                      ),
                    _infoRow(
                    ...
                    _infoRow(
                      ...
                      'Vehicle assigned',
                      _formatDateTime(transport.vehicleAssignedDate),
                      Colors.teal,
                      fontSettings,
                    ),
                  ],
                  if (transport.hasRejection) ...[
                    const Divider(height: 20),
                    _infoRow(
                      Icons.person_off_outlined,
                      'Rejected by',
                      transport.rejectedBy ?? '',
                      Colors.red,
                      fontSettings,
                    ),
                    _infoRow(
                      Icons.event_busy,
                      'Rejected',
                      _formatDateTime(transport.rejectedDate),
                      Colors.red,
                      fontSettings,
                    ),
                    _infoRow(
